...
Associative Arrays - Arryas with named keys
Multidimensional Arrsy - Contains one or more arrys
*/
...
$students = array("Godslove", "Chukwuebuka", "Michael");
echo "<br> These are my students: " . $students[0] . "," . $students[1]. " , and ".
$students[2] . "<br>" . "<br>" ;
...
// Assoxiative Arrays
$age = array("Godslove" => "23", "Chukwuebuka" => "20", "Michael" => "25");
echo "<br>";
echo "Godslove is " . $age['Godslove'] . " Age";
echo "<br>";
echo "Chukwuebuka is " . $age['Chukwuebuka'] . " Age";
echo "<br>";
echo "Michael is " . $age['Michael'] . " Age";
echo "<br>";
